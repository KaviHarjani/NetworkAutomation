  ...
  return (
    <div
      className={`
        ...
        ${selected ? 'border-red-500 ring-2 ring-red-200' : 'border-gray-300'}
    ...
    >
      ...
      <Handle
        ...
        className="w-5 h-5 bg-red-500 border-2 border-white hover:bg-red-600 transition-colors"
        style={{ top: '-10px' }}
      />
      <Handle
        type="target"
      ...
      <div className="text-center">
        ...
        <div className="text-xs font-semibold text-gray-900">End</div>
